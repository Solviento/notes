""" python code for computing gestalt """
import cv2
import sys
import os
import numpy as np
...
def main(argv):
    ...
    for image_a in images_list:
        ...
        for image_b in images_list:
            ...
            S = (non_equal)/float(pixel_number)
    ...
    vertical = np.concatenate((vertical, horizontal), axis=0)
    # final image output
    cv2.imwrite('topimages_gestalt.jpg', vertical)
