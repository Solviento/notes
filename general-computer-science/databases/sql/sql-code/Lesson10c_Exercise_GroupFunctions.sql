...
/* 1.	Total number of assignment records.
*/

/* 2.	Total number of assignment records where consultants have been 
allocated. (Reminder: assignments can have null consultant_ids)
*/

/* 3.	Give the consultant's name and the number of assignment record 
...
/* 12.	Overall average price for each stock at each exchange.  
Please include the name of the company, the name of the stock exchange 
...
the price_totals for his or her trades.  (Remember to convert all currency 
amounts to the currency of your choice.  And feel free to hardcode the 
conversion.to_currency_id to the currency id number that you choose.)
*/
...
/* 18.	Compute each broker's average earning per share worldwide.  Remember to 
