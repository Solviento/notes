...
114, "i love leetcode" should be in front of "ironman". Also we only need to output top 3 hot sentences, so "ironman" will be ignored.
...
public class DesignSearchAutocompleteSystem implements CodeRunner {
    @Override
    public void run() {
