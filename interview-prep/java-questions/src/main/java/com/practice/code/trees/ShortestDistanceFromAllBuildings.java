...
buildings in the shortest total travel distance. You can only move up, down, left, and right.
Return the shortest travel distance for such a house. If it
is not possible to build such a house according to the above rules, return -1.
...
public class ShortestDistanceFromAllBuildings implements CodeRunner {
    @Override
    public void run() {
