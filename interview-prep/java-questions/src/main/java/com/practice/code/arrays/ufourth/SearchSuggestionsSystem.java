...
public class SearchSuggestionsSystem implements CodeRunner {
    @Override
    public void run() {

    }

    // t: M^2 (using Strings) M (using StringBuilder) s: 26n -> n
    ...
    List<List<String>> suggestedProductsBinarySearch(String[] products, String searchWord) {
