...
dictionary, where the strings in words are sorted lexicographically by the rules of this new language.
...
letter in t in the alien language. If the first min(s.length, t.length)
...
public class AlienDictionary implements CodeRunner {
    @Override
    public void run() {
