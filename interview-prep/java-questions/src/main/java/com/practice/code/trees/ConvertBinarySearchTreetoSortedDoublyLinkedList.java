...
You can think of the left and right pointers as synonymous to
the predecessor and successor pointers in a doubly-linked list.
For a circular doubly linked list, the predecessor of the first
...
transformation, the left pointer of the tree node should point
to its predecessor, and the right pointer should point to its
...
import com.practice.code.model.DoublyLinkedListNode;
import com.practice.code.runner.CodeRunner;

public class ConvertBinarySearchTreetoSortedDoublyLinkedList implements CodeRunner {
    @Override
    public void run() {
